                    ...
                    <div className="footer">
                        <div className="footer-socials">
                            <ul className="socials-sh">
                                <li>
                                    <a className="fa sh-socials-url fa-twitter" href="#" title="Twitter"
                                       target="_blank"></a>
                                </li>
                                <li>
                                    <a className="fa sh-socials-url fa-facebook" href="#" title="Facebook"
                                       target="_blank"></a>
                                </li>
                                <li>
                                    <a className="fa sh-socials-url fa-linkedin" href="#" title="LinkedIn"
                                       target="_blank"></a>
                                </li>
                                <li>
                        ...
                        <div className="footer-content">
                            @ 2022 Создано Антоном из <a href="https://krd.top-academy.ru/" title="Pego HTML Themes"
                                                         target="_blank">Академии
                            TOP</a>.
                        </div>
                    </div>
                </div>

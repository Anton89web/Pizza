        ...
        <div className="page-wrapper">
          ...
          <div className="header">
            <div className="container_flex"><a href="/">
              <div className="header__logo" style={{display: "flex", "align-items": "center"}}>
                <img width="38" src="/static/images/logo/pizza-logo.56ac87032d8f6fdf863326acd06c0d97.svg" alt="Pizza logo"/>
                <div>
                  <p style={{"line-height": "15px",  marginBottom: 0, maxWidth: 170}}>Самая вкусная пицца во вселенной</p>
                </div>
              </div>
            </a>
              ...
              <div className="header__cart">
                <a className="button_cart button--cart" href="/cart"><span>0 ₽</span>

...
const Cart = () => {
  ...
  function deletePizza(i) {
    if (window.confirm("Ты точно хочешь удалить этот товар из корзины?")) {
      dispatch(removeProduct(i))
    }
  }

  function clickMinusPizza(id, i) {
            ...
            : <div className="container--cart">
              <div className="cart__top">
                ...
                <div className="cart__clear">
                  ...
                  <span onClick={() => clearCart()}>Очистить корзину</span></div>
              </div>
              <div className="content__items">
                {products.map((obj, i) => (
                  <div className="cart__item" key={obj.id}>
                    ...
                    <div className="cart__item-info"><h3>{obj.title}</h3><p>{obj.testo}, {obj.size} см.</p></div>
                    ...
                    <div className="cart__item-price"><b>{obj.price * obj.count} ₽</b></div>
                    <div className="cart__item-remove">
                      <div onClick={() => deletePizza(i)} className="button button--outline button--circle">
                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M5.92001 3.84V5.76V8.64C5.92001 9.17016 5.49017 9.6 4.96001 9.6C4.42985 9.6 4.00001 9.17016 4.00001 8.64L4 5.76L4.00001 3.84V0.96C4.00001 0.42984 4.42985 0 4.96001 0C5.49017 0 5.92001 0.42984 5.92001 0.96V3.84Z"
                            fill="#EB5A1E"></path>
              ...
              <div className="cart__bottom">
                ...
                <div className="cart__bottom-buttons"><a className="button button--outline button--add go-back-btn"
                                                         href="/">
